    ...
    var tableIns = table.render({
        ...
        cols: [[
            {type: "checkbox", fixed: "left", width: 50},
                    ...
                    {field: 'sex', title: '性别 1 男 0 女', minWidth: 100, align: "center", templet: function (d) {
                            if (d.sex == '0') {
                    ...
                    {field: 'openStatus', title: '任职状态', minWidth: 100, align: "center", templet: function (d) {
                            if (d.openStatus == '0') {
                                return "<button class=\"layui-btn layui-btn-normal layui-btn-xs sz-btn-sm\" style='cursor: default'>在职</button>";
                            } else if (d.openStatus == '1') {
                                return "<button class=\"layui-btn layui-btn-danger layui-btn-xs sz-btn-sm\" style='cursor: default'>离职</button>";
                            }
                        }},
