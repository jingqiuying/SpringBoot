            ...
            {type: "checkbox", fixed: "left", width: 50},
                    ...
                    {field: 'nullifyStatus', title: '是否作废', minWidth: 100, align: "center", templet: function (d) {
                            if (d.nullifyStatus == '0') {
                                return "<button class=\"layui-btn layui-btn-normal layui-btn-xs sz-btn-sm\" style='cursor: default'>作废</button>";
                            } else if (d.nullifyStatus == '1') {
                                return "<button class=\"layui-btn layui-btn-danger layui-btn-xs sz-btn-sm\" style='cursor: default'>在用</button>";
                            }
                        }},
